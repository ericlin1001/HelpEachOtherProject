		...
		<div class="container">
			<div class="row">
				<div class="col-lg-2">
					...
					<li class="nav-li"><a class="displayPoseTaskForm displayForm" href="#">Pose Task</a></li>
					<li class="nav-li"><a class="displayViewTaskForm displayForm" href="#">View Task</a></li>
					<li class="nav-li"><a class="displaySearchUserForm displayForm" href="#">Search User</a></li>
					<li class="nav-li"><a class="displayMessageForm displayForm" href="#">View Message</a></li>
					<li class="nav-li"><a class="displayRankingForm displayForm" href="#">View Ranking</a></li>
					<li class="nav-li"><a class="displaySubmissForm displayForm" href="#">Submiss</a></li>
					<li class="nav-li"><a class="displayFeedbackForm displayForm" href="#">Feedback Us</a></li>
					</ul>
					</div>
				</div>
				<div id="div1" class="col-lg-6">
					<div class="index_div list_div">
						<center><img class="image-circle" src="__ROOT__/Public/img/004.png"/></center>
					</div>
